...
extraContent.BackgroundColor3 = colors.background
extraContent.ClipsDescendants = true

-- Create a scrolling frame for the extra content
local extraScroll = Instance.new("ScrollingFrame")
extraScroll.Parent = extraContent
extraScroll.BackgroundTransparency = 1
extraScroll.Size = UDim2.new(1, 0, 1, 0)
extraScroll.CanvasSize = UDim2.new(0, 0, 0, 420) -- Will adjust based on content
extraScroll.ScrollBarThickness = 6
extraScroll.ScrollBarImageColor3 = colors.secondary

-- Grid layout for buttons
local uiGridLayout = Instance.new("UIGridLayout")
uiGridLayout.Parent = extraScroll
uiGridLayout.SortOrder = Enum.SortOrder.LayoutOrder
uiGridLayout.CellPadding = UDim2.new(0, 5, 0, 10)
uiGridLayout.CellSize = UDim2.new(0.5, -5, 0, 36)
...
invisibilityButton.Parent = extraScroll
...
saturnBypassButton.Parent = extraScroll
...
birdPoopButton.Parent = extraScroll
...
basketballButton.Parent = extraScroll
...
basketballButton.LayoutOrder = 5
...
fruitButton.Parent = extraScroll
fruitButton.BackgroundColor3 = colors.secondary
fruitButton.Font = font
fruitButton.Text = "Fruit"
fruitButton.TextColor3 = colors.text
fruitButton.TextSize = 14
fruitButton.LayoutOrder = 6
...
chatAdminButton.Parent = extraScroll
